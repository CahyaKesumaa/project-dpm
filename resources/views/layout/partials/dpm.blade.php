    ...
    <div class="grid md:grid-cols-2 gap-12">
        <div class="lg:w-3/4">
            ...
            <p class="mt-3 text-gray-800">
                ...
                disepakati berdasarkan hasil musyawarah mufakat.
            </p>
            <p class="mt-5">
        ...
        <div class="space-y-6 lg:space-y-10">
            ...
            <div class="flex gap-x-5 sm:gap-x-8">
                ...
                <span
                    ...
                    <svg fill="#000000" width="800px" height="800px" viewBox="-1 0 19 19"
                        xmlns="http://www.w3.org/2000/svg" class="cf-icon-svg">
                        <path
                            d="M16.417 9.579A7.917 7.917 0 1 1 8.5 1.662a7.917 7.917 0 0 1 7.917 7.917zm-6.37 2.817a.317.317 0 0 0-.316-.317H4.15a.318.318 0 0 0-.317.317v.715a.318.318 0 0 0 .317.317h5.58a.317.317 0 0 0 .317-.317zM5.362 8.655l2.362 2.362a.396.396 0 0 0 .56-.56L5.921 8.096a.396.396 0 1 0-.56.56zm8.05 3.235-3.285-3.285.81-.81L8.593 5.45 6.398 7.644l2.345 2.344.823-.823 3.285 3.285a.396.396 0 1 0 .56-.56zM9.056 4.96l2.363 2.362a.396.396 0 1 0 .56-.56L9.615 4.4a.396.396 0 1 0-.56.56z" />
                    </svg>
                </span>
                <div class="grow">
                    ...
                    <p class="mt-1 text-gray-600">
                        Dalam Dewan Perwakilan Mahasiswa (DPM) merujuk pada proses penyusunan, pembahasan, dan
                        pengesahan aturan atau kebijakan yang berlaku di lingkungan organisasi kemahasiswaan,
                        seperti peraturan internal, tata tertib, dan keputusan strategis.
                    </p>
                </div>
            </div>
            <!-- End Icon Block -->
            ...
            <div class="flex gap-x-5 sm:gap-x-8">
                ...
                <div class="grow">
                    ...
                    <p class="mt-1 text-gray-600">
                        Salah satu fungsi utama yang dilakukan untuk memastikan kegiatan, kebijakan, dan keputusan
                        organisasi mahasiswa dijalankan sesuai dengan aturan dan tujuan yang telah ditetapkan.
                        Fungsi pengawasan ini bertujuan untuk menciptakan akuntabilitas, transparansi, dan
                        efektivitas dalam organisasi kemahasiswaan.
                    </p>
                </div>
            </div>
            <!-- End Icon Block -->
                        ...
                        <g>
                            <g>
                                <g>
                                    ...
                                    <path
                                        d="M149.997,0C67.157,0,0,67.159,0,150c0,82.838,67.157,150,149.997,150C232.841,300,300,232.838,300,150
...
C218.9,208.403,208.728,207.151,201.992,206.326z" />
                ...
                <div class="grow">
                    ...
                    <p class="mt-1 text-gray-600">
                        Merupakan aspek penting yang mendukung operasional DPM agar berjalan secara terstruktur,
                        transparan, dan akuntabel. Administrasi memastikan pengelolaan dokumen, informasi, dan
                        kegiatan berjalan dengan baik, sedangkan keuangan mengelola dana organisasi secara
                        bertanggung jawab.
                    </p>
                </div>
            </div>
...
C391.837,107.394,387.337,113.594,388.637,120.194z" />
                ...
                <div class="grow">
                    ...
                    <p class="mt-1 text-gray-600">
                        Merujuk pada proses penyerapan, pengelolaan, dan penyampaian pendapat, ide, atau keluhan
                        mahasiswa untuk kemudian diperjuangkan sebagai kebijakan, program, atau solusi yang
                        bermanfaat. Sebagai perwakilan mahasiswa, DPM memiliki peran penting dalam menjadi
                        penghubung antara mahasiswa dengan pihak kampus atau organisasi lain.
                    </p>
                </div>
            </div>
            <!-- End Icon Block -->
